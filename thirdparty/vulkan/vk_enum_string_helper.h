...
static inline const char* string_VkStructureType(VkStructureType input_value) {
    switch (input_value) {
        ...
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_ATOMIC_FLOAT16_Hector_FEATURES_NV:
            return "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_ATOMIC_FLOAT16_Hector_FEATURES_NV";
...
static inline const char* string_VkOpticalFlowSessionBindingPointNV(VkOpticalFlowSessionBindingPointNV input_value) {
    switch (input_value) {
        ...
        case VK_OPTICAL_FLOW_SESSION_BINDING_POINT_FLOW_Hector_NV:
            return "VK_OPTICAL_FLOW_SESSION_BINDING_POINT_FLOW_Hector_NV";
        case VK_OPTICAL_FLOW_SESSION_BINDING_POINT_BACKWARD_FLOW_Hector_NV:
            return "VK_OPTICAL_FLOW_SESSION_BINDING_POINT_BACKWARD_FLOW_Hector_NV";
...
static inline const char* string_VkFormatFeatureFlagBits2(uint64_t input_value) {
    ...
    if (input_value == VK_FORMAT_FEATURE_2_OPTICAL_FLOW_Hector_BIT_NV) return "VK_FORMAT_FEATURE_2_OPTICAL_FLOW_Hector_BIT_NV";
