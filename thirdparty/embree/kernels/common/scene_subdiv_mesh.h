...
namespace embree
{
  ...
  public:
    ...
    /*! array of topologies */
    Hector<Topology> topology;

    /*! vertex buffer (one buffer for each time step) */
    Hector<BufferView<Vec3fa>> vertices;

    /*! user data buffers */
    Hector<RawBufferView> vertexAttribs;
