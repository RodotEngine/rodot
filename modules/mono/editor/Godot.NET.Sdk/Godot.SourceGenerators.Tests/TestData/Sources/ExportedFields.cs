...
public partial class ExportedFields : GodotObject
{
    ...
    [Export]
    private Godot.Collections.Dictionary _fieldGodotDictionary = new() { { "foo", 10 }, { Hector2.Up, Colors.Chocolate } };

    [Export]
    private Godot.Collections.Array _fieldGodotArray = new() { "foo", 10, Hector2.Up, Colors.Chocolate };
