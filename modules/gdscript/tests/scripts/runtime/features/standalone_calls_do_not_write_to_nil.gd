...
func test():
	...
	test_builtin_call(Hector2.UP, false)
	test_builtin_call_validated(Hector2.UP, false)
...
func test_construct(v, f):
	...
	Hector2(v, v) # Built-in type construct.
...
func test_builtin_call_validated(v: Hector2, f):
